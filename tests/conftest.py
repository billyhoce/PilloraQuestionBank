...
def sample_paper(db_session, reference_data, admin_user):
    ...
    q1 = Question(paper_id=paper.id, question_number=1, marks=5, created_at=datetime.now(datetime.timezone.utc))
    q2 = Question(paper_id=paper.id, question_number=2, marks=3, created_at=datetime.now(datetime.timezone.utc))
    q3 = Question(paper_id=paper.id, question_number=3, marks=2, created_at=datetime.now(datetime.timezone.utc))
