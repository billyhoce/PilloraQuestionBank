...
export default function LevelModal({ isOpen, onClose, onSave, initialValues, schoolLevels, loading, error }) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={initialValues ? 'Edit level' : 'Add level'}>
